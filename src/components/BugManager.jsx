                    ...
                    <div style={{ marginTop: '10px' }}>
                      ...
                      <div style={{ position: 'relative', display: 'inline-block' }}>
                        ...
                        <button
                          ...
                          style={{ position: 'absolute', top: '4px', right: '4px', background: '#e53e3e', color: 'white', border: 'none', borderRadius: '50%', width: '24px', height: '24px', cursor: 'pointer', fontSize: '14px' }}
                        >
                          ×
                        </button>
                      </div>                    </div>
